...
Última atualização: **2026-07-14, tarde** (**Hierarquia visual**: rótulos sem sobreposição em screen-space, foco no núcleo com painel de assinatura por lift + sublente por interseção, contornos dos núcleos e LOD "vista de dados" — doc 04 §5.11/5.12, doc 03 §14.10; camada ~grátis, montada em App.tsx sem tocar CrowdMesh. Antes: **Lote 5** 116 pessoas; **Mundo-toro + leme**; **Voz v1** cortes no Supabase + player)
