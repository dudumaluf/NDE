...
Última atualização: **2026-07-13, madrugada** (M4a–f: cores no Appearance, Vocabulary, hover com nome, follow em 3ª pessoa, timeline da história, terreno vivo; **Lote 4 em processamento** — mais ~20 pessoas do canal)
...
- **M4 — positionMirror é o limite conhecido do hover/follow**: readback
  ...
  (id-buffer num render target pequeno) — doc 03 §14.6.
