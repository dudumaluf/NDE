...
Última atualização: **2026-07-14, tarde** (**Lote 5 fechado**: corpus de **116 pessoas**, 201 vídeos transcritos, 13 núcleos, manifest `4e20ee9e761a689d`, 9003 cortes — +fix do parser `group.py` para "EQM do/da" e partes em inglês. Antes: **Voz v1** — cortes de áudio no Supabase + player na timeline; Timeline v2 com estações canônicas; campo do ativo/formações/palco)
