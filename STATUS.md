...
Última atualização: **2026-07-13, madrugada** (**Lote 3 — corpus de 66 pessoas**, ver linha "Lote 3"; no mesmo dia: controles de aparência + preset persistente do leva; M3.6 — estados de animação POR AGENTE; protótipo ONLINE na Vercel; frases do visitante; arco emocional + timeline normalizada)
