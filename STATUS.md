...
Última atualização: **2026-07-14, tarde** (**Voz v1**: cortes de áudio no Supabase + player na timeline — o site ganha voz; antes na mesma manhã: Timeline v2 com estações canônicas, campo do ativo/formações/palco, Lote 4 fechado com 86 pessoas, manifest `c1dfc480…` em produção)
