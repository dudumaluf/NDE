...
Última atualização: **2026-07-14, manhã** (**Timeline v2**: estações canônicas entre histórias + filtro de consumo + layout clean — feedback direto do Dudu; antes: M4a–f + fix M4c/d, Lote 4 fechado com 86 pessoas, manifest `c1dfc480…` em produção)
