...
Última atualização: **2026-07-13, madrugada** (M3.6 — estados de animação POR AGENTE dirigidos pela simulação: a multidão deixa de tocar um clipe global; antes no mesmo dia: protótipo ONLINE na Vercel, frases do visitante, arco emocional + timeline normalizada nas 46 pessoas)
