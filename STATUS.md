...
Última atualização: **2026-07-12, fim de tarde** (protótipo ONLINE na Vercel — ver linha "Online (protótipo)"; frases do visitante na taxonomia + arco emocional + timeline normalizada nas 46 pessoas; antes: M3 data layer + demográficos + consolidação das ideias de 2026-07-12 nos docs)
