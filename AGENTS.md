...
4. `Docs/03-briefing-experiencia-3d.md` — arquitetura e marcos (com errata §1)
5. `Docs/ANALISE_TECNICA.md` — engenharia reversa do patch cables.gl original
6. `limiar-experience/AGENTS.md` — fatos técnicos verificados + método do app
7. `Docs/02-briefing-pipeline-dados.md` — só quando for trabalhar no `acervo`
